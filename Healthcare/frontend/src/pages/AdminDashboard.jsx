...
import { Users, UserCheck, Activity, FileText, Calendar, Shield, TrendingUp, CheckCircle, AlertCircle, UserPlus, Clock } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen pb-24">
      {/* Header Section */}
      <div className="bg-linear-to-r from-purple-600 via-indigo-600 to-violet-600 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-4 bg-linear-to-r from-purple-50 to-indigo-50 rounded-xl">
                  ...
                  {users.map((u, index) => (
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-linear-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center text-white font-semibold text-sm">
                      ...
                      <td className="px-6 py-4">
                        {u.role !== 'admin' && (
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            onClick={() => handleDeleteUser(getEntityId(u))}
        ...
        {activeTab === 'pending' && (
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden"
          >
            <div className="p-6 border-b border-gray-100 bg-linear-to-r from-orange-50 to-transparent">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-4">
                  {pendingDoctors.map((doctor, index) => (
                    <motion.div
                      ...
                      className="flex items-center justify-between p-5 bg-linear-to-r from-gray-50 to-white rounded-xl border border-gray-100 hover:shadow-md transition-all"
                    >
                      <div className="flex items-center gap-4">
                        <div className="w-14 h-14 bg-linear-to-br from-orange-400 to-amber-500 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-md">
                      ...
                      <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        onClick={() => handleApproveDoctor(getEntityId(doctor))}
                        className="flex items-center gap-2 px-5 py-3 bg-linear-to-r from-green-600 to-emerald-600 text-white rounded-xl font-semibold shadow-lg shadow-green-500/25 hover:shadow-xl hover:shadow-green-500/30 transition-all"
                      >
