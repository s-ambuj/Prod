...
import { FileText, Activity, Search, Calendar, Download, Pill } from 'lucide-react';
...
const PatientPrescriptions = () => {
  ...
  const filteredPrescriptions = prescriptions.filter(presc => 
    presc.doctor_name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto pb-24">
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500">View and manage all your medical prescriptions</p>
          </div>
      ...
      <div className="relative mb-6">
        ...
        <input
          type="text"
          placeholder="Search by doctor name, medicine, or notes..."
          value={searchTerm}
      ...
      {filteredPrescriptions.length === 0 ? (
        ...
        >
          ...
          <p className="text-sm text-gray-400 mt-1">
            {searchTerm ? 'Try a different search term' : 'Prescriptions will appear here after your appointments'}
          </p>
        </motion.div>
      ) : (
          ...
          {filteredPrescriptions.map((presc, index) => (
            ...
            >
              ...
              <div 
                ...
                onClick={() => setExpandedId(expandedId === presc.id ? null : presc.id)}
              >
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">Dr. {presc.doctor_name}</h3>
              ...
              {/* Expanded Medicines */}
              {expandedId === presc.id && presc.medicines && (
                <motion.div
